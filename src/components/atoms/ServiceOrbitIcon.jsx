      ...
      {variant === "orbit" && (
        <svg viewBox="0 0 56 56" className="h-14 w-14 text-primary-500">
          <g className="so-float so-orbit-group" transformOrigin="28 28">
            ...
            <circle cx="28" cy="28" r="2.8" className="so-orbit-core fill-secondary-500" />
      ...
      {variant === "maintenance" && (
        <svg viewBox="0 0 56 56" className="h-14 w-14 text-primary-500">
          <g className="so-float so-maintenance-group" transformOrigin="28 28">
            ...
            <circle cx="28" cy="28" r="3.2" className="so-maint-core fill-secondary-500" />
          </g>
        </svg>
      )}
      ...
      {variant === "prism" && (
        <svg viewBox="0 0 56 56" className="h-14 w-14 text-primary-500">
          <g className="so-float so-prism-draw" transformOrigin="28 28">
            ...
            <path d="M28 28v18" className="so-prism-stroke-c fill-none stroke-secondary-500" strokeWidth="1.4" />

            <circle cx="28" cy="10" r="1.5" className="so-prism-dot-a fill-primary-500" />
            <circle cx="43" cy="19" r="1.4" className="so-prism-dot-b fill-secondary-500" />
      ...
      {variant === "layers" && (
        <svg viewBox="0 0 56 56" className="h-14 w-14 text-primary-500">
          <g className="so-float so-layers-group" transformOrigin="28 28">
            ...
            <circle cx="42" cy="40" r="1.4" className="so-layer-dot fill-secondary-500" />
          </g>
        </svg>
      )}
      ...
      {variant === "panels" && (
        <svg viewBox="0 0 56 56" className="h-14 w-14 text-primary-500">
          <g className="so-float so-panels-group" transformOrigin="28 28">
            ...
            <path d="M12 30h18" className="so-panel-scan fill-none stroke-secondary-500" strokeWidth="1.3" strokeLinecap="round" />
          </g>
        </svg>
      )}
