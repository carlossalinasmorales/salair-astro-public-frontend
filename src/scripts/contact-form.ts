...
const GENERIC_PLAIN_TEXT_MESSAGE = "Este campo debe contener solo texto plano. No use HTML ni scripts.";
...
export const initContactForm = () => {
  ...
  const mockSubmitContact = async (payload: ReturnType<typeof buildPayload>): Promise<MockSubmitResult> => {
